...
public class AssetManager {
    ...
    public static TextureRegion[] playerRightW_Animation, playerLeftW_Animation, playerUpW_Animation, playerDownW_Animation, playerRightW_Atack, playerLeftW_Atack, playerUpW_Atack, playerDownW_Atack;
    public static TextureRegion[] playerRightS_Animation, playerLeftS_Animation, playerUpS_Animation, playerDownS_Animation, playerRightS_Atack, playerLeftS_Atack, playerUpS_Atack, playerDownS_Atack;
